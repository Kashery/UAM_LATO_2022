...
@Getter
public class MultiAttackRangedCreatureDecorator extends AbstractCreature {
    ...
    private int shots;
    private final int rangedAttacks;
    private boolean isInMelee = false;
    private double range = Integer.MAX_VALUE;

    public MultiAttackRangedCreatureDecorator(final Creature aDecorated, final int aShots, final int aRangedAttacks) {
        super(aDecorated);
        decorated = aDecorated;
        shots = aShots;
        maxShots = aShots;
        rangedAttacks = aRangedAttacks;
